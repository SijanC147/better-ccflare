...
# Retry Configuration
RETRY_ATTEMPTS=3                # Total attempts, the first included (default: 3)
RETRY_DELAY_MS=1000            # Base delay before the first retry, ms (default: 1000)
RETRY_BACKOFF=2                # Multiplier applied per attempt (default: 2)
